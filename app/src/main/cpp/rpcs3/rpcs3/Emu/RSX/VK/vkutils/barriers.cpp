...
namespace vk
{
		...
		bool preserve_renderpass)
	{
		...
		_vkCmdPipelineBarrier(cmd, src_stage, dst_stage, 0, 0, nullptr, 0, nullptr, 1, &barrier);
	}
		...
		bool preserve_renderpass)
	{
		...
		_vkCmdPipelineBarrier(cmd, src_stage, dst_stage, 0, 0, nullptr, 1, &barrier, 0, nullptr);
	}
		...
		bool preserve_renderpass)
	{
		...
		_vkCmdPipelineBarrier(cmd, src_stage, dst_stage, 0, 1, &barrier, 0, nullptr, 0, nullptr);
	}
